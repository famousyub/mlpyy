...
Original file is located at
    https://colab.research.google.com/drive/1Ghb1aQhvJRJzRttlAdqK9TiOZTF-WAFq
"""
...
#crsr.execute("CREATE TABLE  yuboofilm( rating int, review text)")
